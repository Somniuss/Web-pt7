package com.somniuss.web.сonnectionPool;
...
public final class ConnectionPool implements AutoCloseable {
	...
	public static ConnectionPool create(String url, String user, String password, int poolSize)
		...
		try {
			connectionPool.usedConnections = new ArrayBlockingQueue<Connection>(poolSize);
			connectionPool.availableConnections = new ArrayBlockingQueue<Connection>(poolSize);
